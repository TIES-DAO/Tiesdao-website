          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-2xl border border-gray-600/50 bg-gray-800/50 px-4 py-3 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 transition backdrop-blur"
                required
              />
            </motion.div>
            ...
            {error && (
              <motion.div
                ...
                className="p-4 rounded-2xl bg-red-600/20 border border-red-500/50 text-red-300 text-sm font-medium"
              >
                {error}
              </motion.div>
            )}
            ...
            <motion.button
              type="submit"
              disabled={loading}
              whileHover={{ scale: 1.02, boxShadow: "0 0 20px rgba(59,130,246,.5)" }}
              whileTap={{ scale: 0.95 }}
